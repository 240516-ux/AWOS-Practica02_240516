...
let propertyDescription =
  "Hermoso departamento de 3 recámaras, 1 baño y 1 cajón de estacionamiento ubicado en el Centro de Ciudad de México, ubicado en un tercer piso.";
let propertyType = "D"; // H: House D: Department T: Terrain L: Locale W: Warehouse C: Cabin
let propertyIsSaleable = false;
let propertyIsRentable = true;

let propertyPrice = 7500.0;
...
/* Para modificar los datos de una variable basta con acceder a la propiedad deseada a modificar y asignarle su nuevo a través del signo = */
...
const user3 = {
  userID: 60141,
  name: "Uriel Velazques",
  email: "Uriel12@gmail.com",
...
/*creamos una funcion para darle formato a la fecha y sea mas facil de leer por el usuario*/
