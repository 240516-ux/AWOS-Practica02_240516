...
//Test 1: 
console.log("nombreUsuario = Alan, generoUsuario= H ")
saludarUsuario("Alan", "H");
//Test 2: 
console.log("nombreUsuario = Sharely, generoUsuario= M ")
saludarUsuario("Sharely", "M");
//Test 3: 
console.log("nombreUsuario = Jose Luis , generoUsuario= null ")
saludarUsuario("Jose Luis", null);
...
console.log("Test 4 - usuario: alan23 , password: abcde")
loginStatus = login("alan23","abcde");
console.log(`${loginStatus? "El usuario admin se ha logeado correctamente.": "Hubo un error en el login del usuario admin." }`);
...
recoverPassword("Baltazar203@gmail.com", 
